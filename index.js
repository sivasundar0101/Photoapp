...
const apiKey ="MZa2wrYnqgG_u5SyrzAmAnbkJX-94Kr3fZW91lH9_6A";
...
async function searchUnsplash(searchQuery) {
    var select = document.querySelector("select");
var selectedChoice = select.value;
	const endpoint = `https://api.unsplash.com/search/photos?query=${searchQuery}&per_page=${selectedChoice}&page=${currentPage}&client_id=${apiKey}`;
